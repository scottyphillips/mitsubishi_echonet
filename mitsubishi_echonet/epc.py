	...
	0x01: { # Air conditioner-related device class group
		0x30: { # Home air conditioner class
			...
			"functions": {
				...
				0xA1: ('Automatic control of air flow direction setting', f._0130A1),
				0xA3: ('Automatic swing of air flow setting', f._0130A3),
				0xA4: ('Air flow direction (vertical) setting', f._0130A4),
				0xA5: ('Air flow direction (horizontal) setting', f._0130A5),
