from .opcodes import _FF, _0E, _01, _02
# ------------------------------------------------------------------
# EPC set
# ---------------------------------------------------------------- */
...
EPC_CODE = {
	...
	0x02: { # Housing/facility-related device class group
		...
		0x7E: { # Electric vehicle charger/discharger class
			0x80: ('Operation status', _02._7E80),
			0xC0: ('Dischargeable capacity of vehicle mounted battery 1', None),
			0xC1: ('Dischargeable capacity of vehicle mounted battery 2', None),
			0xC2: ('Remaining dischargeable capacity of vehicle mounted battery 1', None),
			0xC3: ('Remaining dischargeable capacity of vehicle mounted battery 2', None),
			0xC4: ('Remaining dischargeable capacity of vehicle mounted battery 3', None),
			0xC5: ('Rated charge capacity', None),
			0xC6: ('Rated discharge capacity', None),
			0xC7: ('Vehicle connection and chargeable/dischargeable status', None),
			0xC8: ('Minimum/maximum charging electric energy', None),
			0xC9: ('Minimum/maximum discharging electric energy', None),
			0xCA: ('Minimum/maximum charging current', None),
			0xCB: ('Minimum/maximum discharging current', None),
			0xD0: ('Used capacity of vehicle mounted battery 1', None),
			0xD1: ('Used capacity of vehicle mounted battery 2', None),
			0xD2: ('Rated voltage', None),
			0xD3: ('Measured instantaneous charging/discharging electric energy', None),
			0xD4: ('Measured instantaneous charging/discharging current', None),
			0xD5: ('Measured instantaneous charging/discharging voltage', None),
			0xD6: ('Measured cumulative amount of discharging electric energy', None),
			0xD7: ('Cumulative amount of discharging electric energy reset setting', None),
			0xD8: ('Measured cumulative amount of charging electric energy', None),
			0xD9: ('Cumulative amount of charging electric energy reset setting', None),
			0xDA: ('Operation mode setting', None),
			0xDB: ('System-interconnecte d type', None),
			0xE2: ('Remaining stored electricity of vehicle mounted battery 1', None),
			0xE3: ('Remaining stored electricity of vehicle mounted battery 2', None),
			0xE4: ('Remaining stored electricity of vehicle mounted battery 3', None),
			0xE7: ('Charging amount setting 1', None),
			0xE9: ('Charging amount setting 2', None),
			0xEB: ('Charging electric energy setting', None),
			0xEC: ('Discharging electric energy setting', None),
			0xED: ('Charging current setting', None),
			0xEE: ('Discharging current setting', None),
			0xEF: ('Rated voltage (Independent)', None)
		},
